...
public class MenuPart extends CommandEventSource {
  ...
  private MenuBar buildMenu() {
    ...
    addMenuItem(editMenu, EditorIcons.Undo(), "Undo", CommandEvent.Command.GENERIC_UNDO);
    addMenuItem(editMenu, EditorIcons.Redo(), "Redo", CommandEvent.Command.GENERIC_REDO);
    ...
    addMenuItem(compilerMenu, EditorIcons.Blank(), "Options...", CommandEvent.Command.GENERIC_ABOUT);
