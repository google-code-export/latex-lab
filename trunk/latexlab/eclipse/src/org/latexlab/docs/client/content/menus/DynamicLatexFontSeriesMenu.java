...
/**
 * Contains a LaTeX Font Series menu with on-demand loading.
 */
public class DynamicLatexFontSeriesMenu extends DynamicMenuBar {

  protected static DynamicLatexFontSeriesMenu instance;
  ...
  /**
   * Constructs a latex font series menu.
   * 
   * @param commandSource the command source
   */
    ...
    GWT.runAsync(new RunAsyncCallback() {
		...
		public void onSuccess() {
		  ...
		  for (int i=0; i<cmds.length; i++) {
			...
			items[i] = DynamicLatexFontSeriesMenu.this.createItem(cmd.getIcon(), cmd.getTitle(), new SystemPasteCommand(cmd.getText()));
		  }
