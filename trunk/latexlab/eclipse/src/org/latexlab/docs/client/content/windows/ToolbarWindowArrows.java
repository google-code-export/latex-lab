 ...
 */
public class ToolbarWindowArrows extends LatexCommandToolbar {
   ...
   */
  public static ToolbarWindowArrows get(final CommandHandler handler, final WindowManager manager) {
    if (instance == null) {
