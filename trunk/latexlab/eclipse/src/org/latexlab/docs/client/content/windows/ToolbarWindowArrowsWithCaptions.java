 ...
 */
public class ToolbarWindowArrowsWithCaptions extends LatexCommandToolbar {
   ...
   */
  public static ToolbarWindowArrowsWithCaptions get(final CommandHandler handler, final WindowManager manager) {
    if (instance == null) {
  ...
  protected ToolbarWindowArrowsWithCaptions() {
	super(SetArrowsWithCaptions.TITLE);
  }
