...
/**
 * A command for toggling a given LaTeX command toolbar.
 */
public class SystemToggleLatexToolbarCommand extends Command {
   ...
   */
  public SystemToggleLatexToolbarCommand(String name) {
