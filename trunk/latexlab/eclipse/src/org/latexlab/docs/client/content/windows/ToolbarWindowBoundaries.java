 ...
 */
public class ToolbarWindowBoundaries extends LatexCommandToolbar {
   ...
   */
  public static ToolbarWindowBoundaries get(final CommandHandler handler, final WindowManager manager) {
    if (instance == null) {
