...
/**
 * Contains a LaTeX Greek Lowercase Letters menu with on-demand loading.
 */
public class DynamicLatexGreekLowercaseLettersMenu extends DynamicMenuBar {

  protected static DynamicLatexGreekLowercaseLettersMenu instance;
    ...
    GWT.runAsync(new RunAsyncCallback() {
		...
		public void onSuccess() {
		  ...
		  for (int i=0; i<cmds.length; i++) {
			...
			items[i] = DynamicLatexGreekLowercaseLettersMenu.this.createItem(cmd.getIcon(), cmd.getTitle(), new SystemPasteCommand(cmd.getText()));
		  }
