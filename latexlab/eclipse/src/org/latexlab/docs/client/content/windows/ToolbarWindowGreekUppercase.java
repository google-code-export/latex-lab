 ...
 */
public class ToolbarWindowGreekUppercase extends LatexCommandToolbar {
   ...
   */
  public static ToolbarWindowGreekUppercase get(final CommandHandler handler, final WindowManager manager) {
    if (instance == null) {
