 ...
 */
public class ToolbarWindowOperators extends LatexCommandToolbar {
   ...
   */
  public static ToolbarWindowOperators get(final CommandHandler handler, final WindowManager manager) {
    if (instance == null) {
