...
public class DocumentServiceEntry implements IsSerializable {
  ...
  private boolean isStarred, isDirty, isSaving, isCompiling, isOpen;
  ...
  /**
   * Retrieves whether the document is currently open for editing.
   * 
   * @return whether the document is currently open for editing
   */
  ...
  /**
   * Sets whether the document is currently open for editing.
   * 
   * @param isOpen whether the document is currently open for editing
   */
